#!/bin/bash
# Battery Saver (Minimal Version) - Startup Script
# Copyright (c) 2025 Daniel
# Licensed under the MIT License

SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
PYTHON_SCRIPT="$SCRIPT_DIR/battery_saver_minimal.py"
...
# Launch the minimal version
python3 "$PYTHON_SCRIPT" &

echo "Battery Saver (Minimal) started successfully!"
echo "The icon will appear in your menu bar near the system battery icon."
echo ""
echo "Icon meanings:"
echo "  ⚡ - Monitoring active"
echo "  🍃 - Low Power Mode is ON"
echo "  XX% - Battery percentage (when enabled)"
